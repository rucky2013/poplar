...
public class NoStrategy implements Route {
    ...
    @Override
    public ControllerMethod controllerMethod(HttpRequest request, String uri) {
        throw new IllegalRouteException("You have created a route, but did not sp∂ecify any method to be invoked.");
    }
